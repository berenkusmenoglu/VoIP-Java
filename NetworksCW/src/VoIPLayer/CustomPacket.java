 ...
 * @author Beren
 */
public class CustomPacket implements Comparable<CustomPacket> {
    ...
    void setPacketData(byte[] bufferToSend) {
        this.packetData = bufferToSend;
    }
    ...
    public static class PacketComparator implements Comparator<CustomPacket> {
        ...
        public int compare(CustomPacket customPacket1, CustomPacket customPacket2) {
            return (int) (customPacket1.packetID - customPacket2.packetID);
        }
